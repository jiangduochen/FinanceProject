...
void DisplayMainMenu()
{
		...
		|| _loggedInUser.Role == Role::Admin)
	{
		...
		cout << "5. Remove books from library" << endl;
...
void CheckInOrOutBook(bool checkOut)
{
	...
	else if(result == CheckInOrOutResult::AlreadyCheckIn || result == CheckInOrOutResult::AlreadyCheckOut)
	{
